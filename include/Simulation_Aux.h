...
void set_default_orientation(struct SimulationState *ss); //double check if this is used for anything other than graphicsw
int get_initial_configuration2(int at, int vc, int initial_config[], struct SimulationState *ss);
