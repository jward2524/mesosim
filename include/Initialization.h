...
void initialize_env_from_config(struct UserInputs *inputs, struct SimulationEnv *se);
void initialize_state_from_config(struct UserInputs *inputs, struct SimulationState *ss);
